...
patch_size = 224
images_paths = glob.glob('C:\\Users\\hasee\\Desktop\\Germany_2024\\Dataset\\train\\masks\\*')
masks_paths = glob.glob('C:\\Users\\hasee\\Desktop\\Germany_2024\\Dataset\\train\\images\\*')
...
for u in images_paths:
    ...
    for count, P in enumerate(patches):
        cv2.imwrite(f"images_patches\\{image_name}_{count}.png", bgr[P[1]:P[1]+patch_size,P[0]:P[0]+patch_size])
...
for u in masks_paths:
    ...
    for count, P in enumerate(patches):
        cv2.imwrite(f"masks_patches\\{image_name}_{count}.png", bgr[P[1]:P[1]+patch_size,P[0]:P[0]+patch_size])
