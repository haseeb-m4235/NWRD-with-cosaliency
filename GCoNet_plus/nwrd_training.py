...
parser.add_argument('--resume',
                    default="C:\\Users\\hasee\\Desktop\\NWRD  Internship\\FineLine\\codes\\GCoNet_plus\\ultimate_duts_cocoseg (The best one).pth",
                    type=str,
...
parser.add_argument('--size',
                    ...
                    type=int,
                    help='input size')
parser.add_argument('--ckpt_dir', default="C:\\Users\\hasee\\Desktop\\NWRD  Internship\\FineLine\\codes\\GCoNet_plus\\ckpt", help='Temporary folder')
...
elif (args.trainset == 'nwrd'):
    root_dir = "C:\\Users\\hasee\\Desktop\\NWRD  Internship\\FineLine\\codes\\rust 300\\training"
    train_img_path = os.path.join(root_dir, 'imgs')
    train_gt_path = os.path.join(root_dir, 'masks')
    train_loader = get_loader(train_img_path,
                              train_gt_path,
                              args.size,
                              1,
...
for testset in args.testsets.split('+'):
    test_loader = get_loader(
        "C:\\Users\\hasee\\Desktop\\NWRD  Internship\\FineLine\\codes\\rust 300\\testing\\imgs",
        "C:\\Users\\hasee\\Desktop\\NWRD  Internship\\FineLine\\codes\\rust 300\\testing\\masks",
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if config.validation:
            ...
            print('Validation: S_measure on NWRD test data set for epoch-{} is {:.4f}. Best epoch is epoch-{} with S_measure {:.4f}'.format(
